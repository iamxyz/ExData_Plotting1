# plot2.R #
# R script for outputing the plot2 figure to both screen and png file"plot2.png"
...
################### STEP 2 : Make the figure plot2 to screen ########################

with(mytable3, plot( datetime, nv3, type = "l",xlab = "", ylab = "Global Active Power (kilowatts)"))



################### STEP 3 : Make the figure plot2 to png file "plot2.png" (480x480) #######################
